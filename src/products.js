...
const products = [
    ...
    {
        title: 'Pellet Kazanlari',
        link:['https://www.daiwa.com.tr/projects/pelet-kazanlari/'],
        brand: ['Daiwa'],
    },

    {
        title: 'Kaloriferli Pellet Sobalari',
        link:['https://www.daiwa.com.tr/projects/pelet-kazanlari/'],
        brand: ['Daiwa'],
    },

    {
        title: 'Uflemeli Pellet Sobalari',
    ...
    {
        title: 'Boyler',
        link:['https://www.baymak.com.tr/urunler/su-isiticilari/boylerler/aqua-tek-serpantinli-hizli-boylerler','https://www.baymak.com.tr/urunler/su-isiticilari/boylerler/aqua-cift-serpantinli-hizli-boylerler'],
        brand: ['Tek Serpantinli Baymak','Çift Serpantinli Baymak'],
    },
